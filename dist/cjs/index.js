...
const Button = ({ onClick, children, size, shape, color, textColor, variant, label, hideLabel, disabled, icon, iconPosition, }) => {
    return (jsxRuntime.jsx(StyledButton, { onClick: onClick, size: size, shape: shape, color: color, textColor: textColor, variant: variant, disabled: disabled, children: !hideLabel ? label || children : "" }));
};
